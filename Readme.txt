...
Чтобы получить ее строку подключения, откройте TestTask.sln, в обозревателе
решений найдите EmloyeeDB.mdf и откройте в обозревателе серверов, после
откройте свойства EmployeeDB.mdf и скопируйте строку подключения оттуда.
